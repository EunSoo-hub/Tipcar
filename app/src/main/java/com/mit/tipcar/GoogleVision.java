...
public class GoogleVision extends AppCompatActivity {
    ...
    private android.widget.TextView mImageDetails;
    ...
    private static class LableDetectionTask extends AsyncTask<Object, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (activity != null && !activity.isFinishing()) {
                android.widget.TextView imageDetail = activity.findViewById(R.id.image_details);
    ...
    private void callCloudVision(final Bitmap bitmap) {
        ...
        try {
            AsyncTask<Object, Void, String> labelDetectionTask = new LableDetectionTask(GoogleVision.this, prepareAnnotationRequest(bitmap));
